(async()=>{
  ...
  const queries = [
    {label:'Hobi Coding Recommendation', text:'Hobi saya suka ngoding cocok jurusan apa? (prioritaskan dokumen HOBY.pdf atau hobi-sesuai-program-studi.docx)'} ,
    ...
    {label:'Double Degree Nasional', text:'Apakah ada program double degree nasional?'} ,
