...
function hasEntity(text, entity) {
  ...
  const aliases = {
    ...
    'inkubator bisnis inbis': ['inbis', 'inkubator bisnis', 'unit kewirausahaan', 'startup', 'wadah inkubasi'],
    'inbis': ['inbis', 'inkubator bisnis', 'unit kewirausahaan', 'startup', 'wadah inkubasi'],
    'inkubator bisnis': ['inbis', 'inkubator bisnis', 'unit kewirausahaan', 'startup', 'wadah inkubasi'],
    'hi think': ['hi think', 'hithink', 'hi-think', 'magang jepang', 'jepang', 'program jepang'],
