const { extractStructuredEntities } = require('../src/engine/ragEngine');
const tests = [
...
tests.forEach(q => { console.log('---', q); console.log(JSON.stringify(extractStructuredEntities(q), null, 2)); });
