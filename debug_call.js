...
const res = tryStructuredExactCostAnswer('berapa rincian biaya prodi ti gelombang 1C?', queryEntities, chunks, 3, Array(64).fill(0));
console.log('RESULT SOURCE:', res && res.source);
console.log('ANSWER:\n', res && res.answer);
console.log('GELB COUNT:', String(res && res.answer).match(/Gelombang\b/gi) || []);
